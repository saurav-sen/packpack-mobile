 ...
 */
public class ScienceNewsFeedTask extends AbstractNetworkTask<String, Integer, Pagination<JRssFeed>> {

    private String pageLink;

    private String errorMsg;

    private static final String LOG_TAG = "ScienceNewsFeedTask";

    public ScienceNewsFeedTask(Context context) {
