...
public class VideosFragmentAdapter extends BaseAdapter {
    ...
    public VideosFragmentAdapter(Activity activity, List<JRssFeed> feeds) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(feed != null) {
            ...
            if(imageUrl != null && !imageUrl.trim().isEmpty()) {
                new DownloadFeedImageTask(home_rss_feed_image, 850, 600, VideosFragmentAdapter.this.activity, loading_progress)
                        .execute(imageUrl);
